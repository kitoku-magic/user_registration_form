...
class user_contact_methods_entity_base(timestamp_mixin_entity, entity):
    ...
    def contact_methods(cls: Type[T]) -> RelationshipProperty:
        return db.relationship('contact_methods_entity', back_populates='user_contact_methods_collection', uselist=False)
    @declared_attr
    def users(cls: Type[T]) -> RelationshipProperty:
        return db.relationship('users_entity', back_populates='user_contact_methods_collection', uselist=False)
